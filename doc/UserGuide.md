...
> The `ADDRESS` must be of the following format: `BLOCK, STREET, UNIT, POSTAL_CODE`.
>
...
Examples: 
* `add John Doe p/98765432 e/johnd@gmail.com a/John street, block 123, #01-01, 010101`
* `add Betsy Crowe pp/1234567 e/betsycrowe@gmail.com pa/Newgate Prison t/criminal t/friend, 291269`
